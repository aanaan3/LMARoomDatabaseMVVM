...
import com.aanaan3.lma.databinding.ActivityMainBinding;
import com.aanaan3.lma.model.Category;
import com.aanaan3.lma.model.Course;
import com.aanaan3.lma.viewmodel.MainActivityViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_COURSE_REQUEST_CODE && resultCode == RESULT_OK){
            ...
            mainActivityViewModel.updateCourses(course);
        }
    }
}